  ...
  return (
    <div className="relative w-screen h-screen overflow-hidden bg-bg">
      ...
      <div className="relative z-10 h-full w-full flex flex-col pitch-slide-pad slide-auto-enter">
        <div className="max-w-[54vw] mb-[3vh]">
        ...
        <div className="grid grid-cols-12 gap-[1.4vw] flex-1 min-h-0">
          <div className="col-span-5 rounded-[1.3rem] border border-text/10 bg-white p-[2.4vh_1.4vw] shadow-[0_12px_36px_rgba(0,45,36,0.08)] flex flex-col">
          ...
          <div className="col-span-4 rounded-[1.3rem] border border-text/10 bg-white p-[2.4vh_1.4vw] shadow-[0_12px_36px_rgba(0,45,36,0.08)] flex flex-col">
            <div className="flex items-center justify-between mb-[1.6vh]">
          ...
          <div className="col-span-3 rounded-[1.3rem] bg-primary-dark text-white p-[2.4vh_1.2vw] flex flex-col justify-between shadow-[0_16px_48px_rgba(0,45,36,0.18)]">
            <div>
