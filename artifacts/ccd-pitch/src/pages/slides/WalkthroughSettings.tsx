/**
 * Slide 8 — Settings: key-stage folders / customisable library.
 */
      ...
      <div className="relative z-10 h-full w-full grid grid-cols-12 gap-[1.64vw] pitch-slide-pad slide-auto-enter">
        <div className="col-span-5 flex flex-col justify-center">
          ...
          <p className="pitch-body-lg mt-[2vh] text-muted font-body leading-relaxed" style={{ textWrap: "pretty" }}>
            Customise your activity library by key stage and category. Switch academic year allocation
            from the year dropdown — your school&apos;s structure, not a fixed template.
          </p>
          <ul className="mt-[2.6vh] flex flex-col gap-[1vh]">
            {[
              ...
              <li key={item} className="flex items-start gap-[0.7vw]">
        ...
        <div className="col-span-7 flex items-center">
          <div className="w-full rounded-[1.3rem] bg-surface border border-text/8 overflow-hidden shadow-[0_16px_48px_rgba(0,45,36,0.1)]">
            <div className="flex items-center justify-between px-[1.3vw] py-[1.3vh] border-b border-text/10 bg-white">
              <span className="font-display font-bold text-text" style={{ fontSize: "1.1vw" }}>Library · key stages</span>
              <div className="flex items-center gap-[0.5vw] rounded-[0.5rem] border border-text/15 px-[0.8vw] py-[0.55vh]">
                <span className="font-body text-muted" style={{ fontSize: "0.75vw" }}>Year</span>
                <span className="font-display font-semibold text-primary-dark" style={{ fontSize: "0.85vw" }}>2025–26 ▾</span>
              </div>
            </div>
            <div className="p-[1.3vw] grid grid-cols-3 gap-[0.9vw]">
              {folders.map((folder) => (
                ...
                >
                  ...
                  <div className="font-display font-bold text-text" style={{ fontSize: "1.05vw" }}>{folder}</div>
                  <div className="font-body text-muted" style={{ fontSize: "0.75vw" }}>Customisable folder</div>
                </div>
              ))}
            </div>
          </div>
