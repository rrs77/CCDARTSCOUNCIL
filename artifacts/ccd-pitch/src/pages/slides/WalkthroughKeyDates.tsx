    ...
    <div className="relative w-screen h-screen overflow-hidden bg-bg">
      ...
      <div className="relative z-10 h-full w-full grid grid-cols-12 gap-[1.64vw] pitch-slide-pad slide-auto-enter">
        <div className="col-span-5 flex flex-col justify-center">
          ...
          <div className="mt-[2.8vh] rounded-[1rem] border border-primary/25 bg-primary/5 p-[1.6vh_1.1vw]">
          ...
          <div className="w-full rounded-[1.3rem] bg-surface border border-text/8 overflow-hidden shadow-[0_16px_48px_rgba(0,45,36,0.1)]">
            ...
            <div className="p-[1.2vw] flex flex-col gap-[0.9vh]">
              {[
                ...
                <div key={row.title} className="flex items-center gap-[1vw] rounded-[0.75rem] border border-text/10 bg-white px-[1vw] py-[1.2vh]">
