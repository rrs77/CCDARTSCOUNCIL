...
function SubjectManagement() {
  // USE DATACONTEXT with safe defaults
  ...
  const safeSubjectCategories = subjectCategories || [];
  ...
  const handleSaveCategory = async () => {
    ...
    try {
      if (editingCategory) {
        ...
        const maxOrder = safeSubjectCategories.length > 0 
          ? Math.max(...safeSubjectCategories.map(c => c.sort_order), 0)
          : 0;
  ...
  if (subjectsLoading || !dataContext) {
    return (
        ...
        <div className="flex min-h-[500px] max-h-[70vh]">
          ...
          <div className="w-1/3 border-r border-gray-200 bg-gray-50">
            <div className="px-4 py-3 border-b border-gray-200">
              <h3 className="font-semibold text-gray-900">Subjects ({safeSubjects.length})</h3>
            </div>
            <div className="overflow-y-auto" style={{ height: 'calc(70vh - 120px)' }}>
              ...
              <>
                    ...
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-600">
                          {safeSubjectCategories.length} categories
                        </p>
                      </div>
                    </div>
                    <button
                ...
                <div className="p-4 overflow-y-auto" style={{ height: 'calc(70vh - 180px)' }}>
                  <div className="space-y-3">
                    {safeSubjectCategories.map((category, index) => (
                      <div
                        key={category.id}
                      ...
                      >
                        <div className="flex items-center justify-between">
                          ...
                          <div className="flex items-center space-x-2">
                            ...
                            {/* Move Down */}
                            {index < safeSubjectCategories.length - 1 && (
                              <button
                                onClick={() => handleReorderCategory(index, index + 1)}
                                className="p-1 text-gray-400 hover:text-blue-600 rounded"
                                title="Move down"
                    ...
                    {safeSubjectCategories.length === 0 && (
