  ...
  const unitSteps: GuideStep[] = [
    {
      ...
      highlightSelector: '[data-tab="unit-viewer"]'
    },
    {
  ...
  const partnersSteps: GuideStep[] = [
    {
      ...
      content: (
        <div className="space-y-3">
          ...
          <p><strong>OmniMusic</strong> uses the Resource Zone: the AMT hub link plus free session PDFs. Drama education hubs include <strong>RSC Education</strong>, <strong>Bristol Old Vic</strong>, and <strong>Kneehigh</strong>. Other partners (Jazz North, LSO, ROH, We Teach Drama, and more) have their own resource cards and planner actions.</p>
        </div>
      )
    },
    {
