...
writeDoc('ems-dj-workshop-course-notes.pdf', 'Essex Music Service — DJ Workshop (example course notes)', [
  '## Purpose',
  'CCDesigner prototype course notes for the EMS DJ Workshop mock product page. Inspired by the public Curriculum Enhancement workshops listing on essexmusicservice.org.uk. Not official EMS tutor packs.',
  '',
  '## Workshop snapshot (public listing)',
  'DJ Workshops — tutors introduce and support students in DJ and music production, tailored to the school.',
  'Suitable for EYFS–KS3 & SEND (brochure / live music pages). Assemblies, half-day and full-day options.',
  'Public price: £250 per day (curriculum enhancement workshops page).',
  '',
  '## Learning outcomes (prototype)',
  ...
  '',
  '## Success criteria',
  '- Handle equipment carefully and take turns',
  '- Keep a steady pulse when cueing or looping',
  '- Mini mix has a clear start, middle and end',
  '- Name one control used (crossfader / EQ / cue)',
  '',
  '## Suggested day shape (showcase lesson ~75 min core + rotations)',
  '1. Deck tour & safety (15) — studio rules, controls map, demo mix (intro / drop / outro).',
  '2. Beat matching basics (20) — rotate driver / navigator / feedback; clean crossfades.',
  '3. Build a mini mix (25) — plan structure; 45–60 second sketch; optional EQ/filter colour.',
  '4. Share and reflect (15) — perform; peer feedback; exit ticket; booking next step.',
  '',
  '## Station rota tip',
  'Keep groups of 3–4. Cap volume. Celebrate careful listening over flashy moves.',
  '',
  '## Differentiation',
  'Support: paired roles, visual step cards, pre-set loops.',
  'Challenge: longer mix, two-track blend, MC spoken intro.',
  'SEND: quieter station; listening-only vocabulary pathway.',
  '',
  '## Vocabulary',
  'Deck · crossfader · cue · EQ · beat matching · loop · drop · mix · pulse · groove',
  '',
  '## How to demo in CCDesigner',
  'Partner Hubs → Essex Music Service → Add DJ showcase lesson → Year 6 Music → Lesson Library → Export PDF.',
  '',
  '## Official booking',
  'https://www.essexmusicservice.org.uk/site/making-music-in-school/curriculum-enhancement-workshops/',
  'Contact: musichub@essex.gov.uk',
]);
copyFileSync(join(examplesDir, 'ems-dj-workshop-course-notes.pdf'), join(emsDir, 'ems-dj-workshop-course-notes.pdf'));

writeDoc('ems-rap-it-workshop-course-notes.pdf', 'Essex Music Service — Rap-It! Workshop (example course notes)', [
  '## Purpose',
  'CCDesigner prototype course notes for the EMS Rap-It! Workshop mock product page. Inspired by the public Curriculum Enhancement workshops listing. Not official EMS tutor packs.',
  '',
  '## Workshop snapshot (public listing)',
  'Rap-It! introduces students to rap, hip-hop, grime and spoken word.',
  'Builds confidence; links music with other curricula — especially English and literacy.',
  'Suitable for KS2–KS4. Public price: £250 per day.',
  '',
  '## Learning outcomes (prototype)',
  ...
  '## Success criteria',
  '- Lyrics fit the beat',
  '- Rhyme or strong word choice used on purpose',
  '- Clear words and respectful listening',
  '- Everyone contributes ideas',
  '',
  '## Suggested day shape (showcase lesson)',
  '1. Pulse, rhyme and respect (15) — community rules; pulse games; model excerpt.',
  '2. Lyric lab (25) — theme bank; draft 4–8 bars; peer clarity edit.',
  '3. Flow rehearsal (20) — fit to loop; mark breaths; optional call-and-response.',
  '4. Cipher share (15) — perform; literacy + music feedback; exit ticket.',
  '',
  '## Literacy links',
  'Word choice, rhyme, imagery, oracy, audience awareness — ideal cross-curricular evidence for English and music.',
  '',
  '## Differentiation',
  'Support: rhyme banks, sentence starters, 2-bar challenge, teacher scribe.',
  'Challenge: hook + verse; figurative language; two-voice structure.',
  'EAL: mother-tongue brainstorm then English performance lines.',
  '',
  '## Vocabulary',
  'Rap · hip-hop · grime · spoken word · bar · rhyme · flow · pulse · cipher · verse · hook',
  '',
  '## How to demo in CCDesigner',
  'Partner Hubs → Essex Music Service → Add Rap-It! showcase lesson → Year 6 Music → Lesson Library → Export PDF.',
  '',
  '## Official booking',
  'https://www.essexmusicservice.org.uk/site/making-music-in-school/curriculum-enhancement-workshops/',
  'Contact: musichub@essex.gov.uk',
]);
copyFileSync(join(examplesDir, 'ems-rap-it-workshop-course-notes.pdf'), join(emsDir, 'ems-rap-it-workshop-course-notes.pdf'));

const tbmhDir = join(root, 'public', 'partners', 'triborough');
mkdirSync(tbmhDir, { recursive: true });

writeDoc(
  'tbmh-groove-n-play-course-notes.pdf',
  "Tri-Borough Music Hub — Groove'n'Play WCIL (example course notes)",
  [
    '## Purpose',
    "CCDesigner prototype course notes for the TBMH Groove'n'Play mock product page. Inspired by public Tri-Borough Music Hub school services listings. Not official Groove'n'Play / TBMH tutor packs.",
    '',
    '## Programme snapshot (public listing)',
    "Every school can access a FREE whole-class annual online licence for ONE Groove'n'Play programme for school delivery, plus free CPD for one teacher (worth £85).",
    'Licence unlocks groove@school digital resources: animated delivery content, teachers’ e-book, session plans, planning and progression docs linked to the National Curriculum and National Plan for Music.',
    '',
    '## Learning outcomes (prototype)',
    ...
    '',
    '## Success criteria',
    '- Keep a steady pulse with the class',
    '- Start and stop together',
    '- Change dynamics when directed',
    '- Listen to other parts while playing',
    '',
    '## Suggested lesson shape (~60 min)',
    '1. Pulse warm-up & class band rules (10)',
    '2. Learn the groove pattern (20) — call-and-response chunks',
    '3. Layer parts & dynamics (20)',
    '4. Class performance & reflect (10) — exit ticket; signpost FREE GnP licence',
    '',
    '## Differentiation',
    'Support: larger note values, colour-coded parts, partner players.',
    'Challenge: 2-bar fills; lead a call.',
    'SEND: adaptive instruments; visual pulse cards; listening pathway.',
    '',
    '## How to demo in CCDesigner',
    "Partner Hubs → Tri-Borough Music Hub → Add Groove'n'Play showcase → Year 4 Music → Lesson Library → Export PDF.",
    '',
    '## Official links',
...
copyFileSync(
  join(examplesDir, 'tbmh-groove-n-play-course-notes.pdf'),
  join(tbmhDir, 'tbmh-groove-n-play-course-notes.pdf'),
);

writeDoc(
  'tbmh-music-makes-me-course-notes.pdf',
  'Tri-Borough Music Hub — Music Makes Me Song-writing (example course notes)',
  [
    '## Purpose',
    'CCDesigner prototype course notes for the TBMH Music Makes Me mock product page. Inspired by the public FREE Teaching & Learning song-writing resource listing. Not the official downloadable PDF pack.',
    '',
    '## Resource snapshot (public listing)',
    'Music Makes Me helps schools co-create songs that can become a school, class or year-group anthem.',
    'Five strands: Social Story Songs; Transition Songs; Emotional Regulation songs; Topic Songs; Celebration Songs.',
    '',
    '## Learning outcomes (prototype)',
    ...
    '- Shared hook',
    '- Can explain who the song is for',
    '',
    '## Suggested lesson shape (~60 min)',
    '1. Choose our song strand (10) — vote theme & audience',
    '2. Hook & verse lyric lab (20)',
    '3. Melody / chant fit (15)',
    '4. Anthem share (15) — reflect; signpost FREE resource download',
    '',
    '## Wellbeing & curriculum links',
    'Transition support, emotional regulation, topic enrichment, celebration assemblies — strong PSHE / literacy crossover.',
    '',
    '## How to demo in CCDesigner',
    'Partner Hubs → Tri-Borough Music Hub → Add Music Makes Me showcase → Year 5 Music → Lesson Library → Export PDF.',
    '',
    '## Official links',
    'https://www.triboroughmusichub.org/school-services/curriculum-guidance-for-schools/',
...
copyFileSync(
  join(examplesDir, 'tbmh-music-makes-me-course-notes.pdf'),
  join(tbmhDir, 'tbmh-music-makes-me-course-notes.pdf'),
);
