          ...
          <FadeIn delay={0.08}>
            {submitted ? (
              ...
              >
                ...
                <button
                  type="submit"
                  className="mt-6 inline-flex min-h-12 w-full items-center justify-center rounded-md bg-gold px-6 py-3 text-base font-bold text-ink transition hover:bg-gold-bright sm:w-auto"
                >
                  Send enquiry
                </button>
