...
Canvas zones follow the key-stage pathway `##` headings (Primary / EYFS–KS2 → Secondary / KS3–KS4 → KS5 / A-level → University / HE → CCDesigner). Nest supporting material under `###` rather than inventing new stats.
