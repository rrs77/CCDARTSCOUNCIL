...
export const sources: Record<string, SourceRef> = {
  ...
  curriculumReview2025: {
    id: "curriculumReview2025",
    label: "Curriculum and Assessment Review Final Report / government response",
    year: "Nov 2025",
    url: "https://www.gov.uk/government/publications/curriculum-and-assessment-review-final-report",
  },
  oakMusic: {
    id: "oakMusic",
    label: "Oak National Academy — Music (free curriculum resources)",
    year: "2025/26",
    url: "https://www.thenational.academy/teachers/key-stages/key-stage-1/subjects/music",
  },
  bbcTeachMusic: {
    id: "bbcTeachMusic",
    label: "BBC Teach — Primary Music",
    year: "ongoing",
    url: "https://www.bbc.co.uk/teach/topics/cmjp647k3e8t",
  },
  ofqualBackground: {
    id: "ofqualBackground",
